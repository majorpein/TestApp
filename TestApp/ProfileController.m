...
@synthesize avatarNameCell, emailCell, phoneCell;
...
- (IBAction) onSignOutClick:(id)sender {
    ...
    [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"AuthorizationToken"];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"EditProfileSegue"]) {
        ...
        ProfileEditingController *pr = (ProfileEditingController *)v.visibleViewController;
        [pr setProfileController:self];
    }
}
